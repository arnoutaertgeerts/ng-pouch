(function() {
    ...
    function SyncFunction($q, $timeout, Yng, yngutils, PouchyngCommon) {
        return function (name, url, filter, sortBy) {
            var common = new PouchyngCommon(name, url, filter, sortBy);
            common.copyApi(this);
            ...
            this.remove = function (docOrId) {
                return $timeout(function () {
                    ...
                    return common.db.put(empty).then(function () {
